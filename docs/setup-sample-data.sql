...
insert into PeopleUnavailableReasons values(NULL, 16, 1, to_date('2018-10-08', 'YYYY-MM-DD'), 'STUDENT - P', 1);
insert into PeopleUnavailableReasons values(NULL, 16, 2, to_date('2018-12-27', 'YYYY-MM-DD'), 'EMPLOYED - P...',  1);
...
insert into ScheduleItemsReasons values(2, 1, 'directive from mgmt'  , 'yellow');  /* formerly 2 */
insert into ScheduleItemsReasons values(3, 1, 'personal appt.'       , null);  /* formerly 1 */
...
insert into ActivitiesTypes values(4,     4, null, 1,    1, 'Desk',                      'DESK',       1, 0,   'darkred',    null, null,         null, null, 0.5, 1); /* work** */
insert into ActivitiesTypes values(5,     3, null, 1,    1, 'Kitchen (*head chef)',      'Kitchen',    1, 0, 'limegreen',    null, null,         null, null, 0.5, 1); /* work** */
insert into ActivitiesTypes values(6,     1, null, 1,    1, 'Truck',                     'TRUCK',      1, 0,        null,    null, null,         null, null, 1.0, 1);
insert into ActivitiesTypes values(7,     2, null, 1,    1, 'Germantown Store',          'Lighthouse', 1, 0,'darkorange',    null, null,         null, null, 1.0, 1); /*work#1*/
...
insert into ActivitiesTypes values(15, null, null, 1,    0, null,                         'OFF',       0,0,        'red',    null, null,         null, null, 0.5, 1); /*malleable half day off*/
insert into ActivitiesTypes values(16, null, null, 1,    1, 'OFF',                        'OFF*',      0,0,        'red',    null, null,         null, null, 1.0, 1); /*firm full day off*/
insert into ActivitiesTypes values(17, null, null, 1,    0, 'TABE',                          '&',      0,0,        'red',    null, null,         null, null, 0.5, 1);
insert into ActivitiesTypes values(18,    5, null, 1,    1, 'Lab Assistant',              null,        0,0,         null,    null, null,         null, null, 0.5, 1);
insert into ActivitiesTypes values(19, null, null, 2,    1, 'Job Hunting on Days Listed', 'JbSrch',    0,0,         null,    null, null,         null, null, 1.0, 1);
insert into ActivitiesTypes values(20, null, null, null, 0, 'Counseling',                 null,        0,0,       null,      null, 'HH12',      'red',    1, 0.5, 1);
insert into ActivitiesTypes values(21, null, null, null, 0, 'Tutoring',                   null,        0,0,       null,      null, 'HH12',       null, null, 0.5, 1);
insert into ActivitiesTypes values(22, null, null, null, 0, 'Computer Class',             '^^',        0,0,         null,  'plum', null,         null, null, 0.5, 1);
insert into ActivitiesTypes values(23, null, null, null, 0, 'Other Class',                '^',         0,0,         null,  'plum', null,         null, null, 0.5, 1);


/*                            W,        first,        last */
insert into Weeks values(201910, '2019-03-11', '2019-03-17');
...
insert into ScheduleItems values(null,  1, 201910,   1,  8, null                     , null     , null);
insert into ScheduleItems values(null,  1, 201910,   1, 21, to_time('14:00', 'hh:mm'), null     , null);
insert into ScheduleItems values(null,  1, 201910,   2,  2, null                     , null     , null);
insert into ScheduleItems values(null,  1, 201910,   2, 21, to_time('14:00', 'hh:mm'), null     , null);
insert into ScheduleItems values(null,  1, 201910,   3,  2, null                     , null     , null);
insert into ScheduleItems values(null,  1, 201910,   3, 22, null                     , null     , null);
insert into ScheduleItems values(null,  1, 201910,   3, 20, to_time('14:00', 'hh:mm'), null     , null);
insert into ScheduleItems values(null,  1, 201910,   4,  7, null                     , null     , null);
insert into ScheduleItems values(null,  1, 201910,   5, 15, null                     , null     , null);
insert into ScheduleItems values(null,  1, 201910,   6,  2, null                     , null     , null);
insert into ScheduleItems values(null,  1, 201910,   7, 15, null                     , null     , null);

insert into ScheduleItems values(null,  2, 201910,   1,  8, null                     , null     , null);
insert into ScheduleItems values(null,  2, 201910,   1, 20, to_time('13:00', 'hh:mm'), null     , null);
insert into ScheduleItems values(null,  2, 201910,   2, 19, null                     , null     , 1);
insert into ScheduleItems values(null,  2, 201910,   2,  2, null                     , null     , null);
insert into ScheduleItems values(null,  2, 201910,   3, 19, null                     , null     , null);
insert into ScheduleItems values(null,  2, 201910,   4,  2, null                     , null     , null);
insert into ScheduleItems values(null,  2, 201910,   5,  2, null                     , null     , null);
insert into ScheduleItems values(null,  2, 201910,   6, 19, null                     , null     , null);
insert into ScheduleItems values(null,  2, 201910,   7, 15, null                     , null     , null);

insert into ScheduleItems values(null,  3, 201910,   1,  8, null                     , null     , null);
insert into ScheduleItems values(null,  3, 201910,   1,  6, null                     , null     , null);
insert into ScheduleItems values(null,  3, 201910,   2,  2, null                     , null     , null);
insert into ScheduleItems values(null,  3, 201910,   2, 20, to_time('13:00', 'hh:mm'), null     , null);
insert into ScheduleItems values(null,  3, 201910,   3, 19, null                     , null     , null);
insert into ScheduleItems values(null,  3, 201910,   4,  7, null                     , null     , null);
insert into ScheduleItems values(null,  3, 201910,   5,  2, null                     , null     , null);
insert into ScheduleItems values(null,  3, 201910,   5, 19, null                     , null     , null);
insert into ScheduleItems values(null,  3, 201910,   6, 19, null                     , null     , null);
insert into ScheduleItems values(null,  3, 201910,   7, 15, null                     , null     , null);
