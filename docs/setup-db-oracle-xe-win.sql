...
/*
create pluggable database wdpdb admin user appwdsetup identified by arst2020#PW
...
create user c##appwdsetup identified by arst1906#DB;
create user c##appwd identified by arst2020#PW;
*/
...
*/
connect appwdsetup/arst1906#DB@localhost:1521/wdpdb as sysdba
/* above should work */
...
grant CONNECT, CREATE SESSION, CREATE TABLE, UNLIMITED TABLESPACE, CREATE VIEW, CREATE PROCEDURE, CREATE SEQUENCE to appwdsetup;
disconnect
connect / as sysdba
grant CREATE SESSION to appwdsetup;
connect appwdsetup/arst1906#DB@localhost:1521/wdpdb */
...
grant c##WD_DBA_ROLE to c##appwd;
*/
/* appwd does not exist */
/* c##appwd does not exist */
/*TODO: instead of above, do something like:
create role c##WD_PUBLISH_SCHEDULE_ROLE;
create role c##WD_DBA_ROLE;
grant c##WD_PUBLISH_SCHEDULE_ROLE to appwd;
grant c##WD_DBA_ROLE to appwdsetup;
*/
...
/*
create database appwddb
    user appwd identified by 'arst2020#PW'
